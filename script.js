...
const gifs = [ "assets/images/togepi-happy.gif", "assets/images/aditi2.jpg", "assets/images/togepi-sad-1.gif","assets/images/aditi1.jpg", "assets/images/togepi-sad-2.gif", "assets/images/togepi-crying.gif"];
// array of messages
const buttonMessages = ["Are you sure??", "Aditoo please", "PLEASE", "You can't do this to me!", "This is not right!"];

// no button clicked
noButton.addEventListener("click", () => {
// always set the gif, clamp the index to avoid overflow
